...
;hljs.registerLanguage("typescript",e)})();/*! `http` grammar compiled for Highlight.js 11.5.1 */
...
;hljs.registerLanguage("http",e)})();/*! `scss` grammar compiled for Highlight.js 11.5.1 */
(()=>{var e=(()=>{"use strict"
